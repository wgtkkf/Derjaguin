# Derjaguin approximation for FE (W/m2 to W)
...
from lip_FE import liner_interpolate # import function
...
while gap < gapmax:
    ...
    while sr < srmax:
        ...
        ind_h = liner_interpolate(dtldr/ucnano) # ([nm]), [W/m2]

        # individual conductance
        ind_g = ind_h*(2*np.pi*sr)*dsr # [W], (W/m2)*m2
    ...
    f0.write(str(' '))
    f0.write(str(total_g/ucnano)) # total conductance [nW]
    f0.write('\n')
