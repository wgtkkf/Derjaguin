# Liner InterPolation: LIP for FE
# read gap & power data W/m2 files as input
...
# parameters
number = 55 # number of data points x & fx, from 0 to 25
number = 35 # number of data points x & fx, from 0 to 25
...
data = pd.read_csv("../derjaguin/input_p_FE_au.txt", sep="\t", header=None) # in case of FE
data.columns = ["gap (nm)", "power (W/m2)"]
